package cl.Biblio.Biblio.repository;
...
public class LibroRepository {
    ...
    public LibroRepository(){
        ...
        listaLibros.add(new Libro(10, "9780132350884", "Clean Code", "Prentice Hall", 2023, "Robert C. Martin"));
    }
    ...
    public Libro buscarPorIsbnV2(String isbn){
        for(Libro libro : listaLibros){
            if(libro.getIsbn().equals(isbn)){
                return libro;
            }
    ...
    public List<Libro> listaOrdenadosPorAnio(){
        List<Libro> copia = new ArrayList<>(listaLibros);

        copia.sort((l1, l2) -> l1.getFechaPublicacion() - l2.getFechaPublicacion());
        return copia;
    }
